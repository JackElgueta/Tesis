...
In agreement to the problematics previously mentioned, a study based on investigations will be exposed, on factors that influence the desertion of the students the careers of engineering. In order to generate a predictive model of the desertion, based on data from students of a private institution .\\
